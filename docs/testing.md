...
| native startup, restart, search and citation | `scripts/loop/runtime-gate.sh --ci` | real macOS Tauri process, main WKWebView rendering, fresh/restart persistence and actual runtime/search/citation IPC |
