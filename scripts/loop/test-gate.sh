...
grep -F "PR reactions (post-request +1 is clean merge evidence):" \
...
# A PR-body +1 created after the current-head request is Codex's documented
# clean-review signal and is sufficient when no clean comment is posted.
